...
/*
    ...
    public void render(OminousBeaconBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay)
    {
        matrices.push();
        {
            ...
            AbstractTexture texture = minecraft.getTextureManager().getTexture(OMINOUS_BEAM_TEXTURE);
...
*/
    ...
    {
        return Vec3d.ofCenter(ominousBeaconBlockEntity.getPos()).multiply(1.0, 0.0, 1.0).isInRange(vec3d.multiply(1.0, 0.0, 1.0), this.getRenderDistance());
    }
